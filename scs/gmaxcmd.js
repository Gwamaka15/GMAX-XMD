...
const date = moment().format('DD/MM/YYYY');
  ...
  *GMAX MD IS RUNNING WITH [${cm.length}0] COMMANDS*
...
`;
   ...
   if (lien.match(/\.(mp4|gif)$/i)) {
    try {
        zk.sendMessage(dest, { video: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *ᴡᴀᴛsᴏɴ*, déveloper ɢᴍᴀx Tech" , gifPlayback : true }, { quoted: ms });
    }
    catch (e) {
