...
async function getOAuthToken() {
  ...
  try {
    const _0x4f97d8 = await axios.get("https://sandbox.safaricom.co.ke/oauth/v1/generate?grant_type=client_credentials", {
      'headers': {
...
async function topUpAirtime(_0x29df76, _0x36bcae) {
  ...
  try {
    const _0x3bf04a = await axios.post("https://sandbox.safaricom.co.ke/mpesa/stkpush/v1/processrequest", _0x56b7d8, {
      'headers': {
...
async function sendMoney(_0xa64ce1, _0x3c87fa) {
  ...
  try {
    const _0x165a69 = await axios.post("https://sandbox.safaricom.co.ke/mpesa/sendmoney/v1/processrequest", _0xb4b207, {
      'headers': {
