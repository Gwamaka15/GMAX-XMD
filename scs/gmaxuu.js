...
// bug database
const { bugtext1 } = require("../Gmax/bugs/bugtext1");
const { bugtext2 } = require("../Gmax/bugs/bugtext2");
const { bugtext3 } = require("../Gmax/bugs/bugtext3");
const { bugtext4 } = require("../Gmax/bugs/bugtext4");
const { bugtext5 } = require("../Gmax/bugs/bugtext5");
const { bugtext6 } = require("../Gmax/bugs/bugtext6");
const { bugpdf } = require("../Gmax/bugs/bugpdf.js");
