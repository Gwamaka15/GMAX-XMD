...
adams({ nomCom: "dev", categorie: "General", reaction: "🚘" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      ...
      { nom: "᚛Baraka᚜", numero: "255622053093" },
      { nom: "watson", numero: "255753853473" },
...
adams({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {
  ...
  repondre("THANK YOU FOR CHOOSING BMW, HERE ARE OUR SUPPORTIVE LINKS\n\n ☉ CHANNEL LINK IS HERE ☉ \n\n❒⁠⁠⁠⁠[https://whatsapp.com/channel/0029VaFytPbAojYm7RIs6l1x] \n\n ☉ GROUP LINK IS HERE ☉\n\n❒⁠⁠⁠⁠[https://chat.whatsapp.com/BFOHuniYUMaENY0aatbMfD] \n\n ☉YOUTUBE LINK IS HERE ☉\n\n❒⁠⁠⁠⁠[https://www.youtube.com/@gmaxtv1661] \n\n\n𝑪𝒓𝒆𝒂𝒕𝒆𝒅 𝒃𝒚 mr Gmax") 
  await zk.sendMessage(auteurMessage,{text : `THANK YOU FOR CHOOSING GMAX-XMD,MAKE SURE YOU FOLLOW THESE LINKS. `},{quoted :ms})
