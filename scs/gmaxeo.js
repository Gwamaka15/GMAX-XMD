...
adams({
  ...
  if (_0x54f98d) {
    ...
    const _0x305ae3 = "𝐆𝐌𝐀𝐗 𝐌𝐃 𝐆𝐈𝐓𝐇𝐔𝐁 𝐈𝐍𝐅𝐎𝐌𝐄𝐓𝐈𝐎𝐍.  \n𝐂𝐑𝐄𝐓𝐄𝐃 𝐁𝐘 𝐌𝐫 𝐆𝐦𝐚𝐱.\n\n𝐒𝐓𝐀𝐑⭐ 𝐓𝐇𝐄 𝐑𝐄𝐏𝐎 𝐓𝐇𝐄𝐍 𝐅𝐎𝐑𝐊🍴\n\n📂 Repository Name: *GMAX-XMD*\n📝 Last Update: " + _0x33ab65.lastUpdate + "\n👤 Owner: *Mr Gmax*\n⭐ Stars: " + _0x33ab65.stars + "\n🍴 Forks: " + _0x33ab65.forks + "\n🌐 Repo: " + _0x54f98d.html_url + "\n⭕ For More Info : https://github.com/Gmaxhacker1/GMAX-XMD";
...
adams({
  ...
  const _0x21464f = await fetch("https://api.github.com/repos/Gmaxhacker1/GMAX-XMD");
...
adams({
  ...
  const _0x10746e = await fetch("https://api.github.com/repos/Gmaxhacker1/GMAX-XMD");
